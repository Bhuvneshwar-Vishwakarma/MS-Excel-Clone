...
$(document).ready(function () {
  ...
  $(".input-cell").dblclick(function () {
    $(".input-cell.selected").removeClass("selected");
    $(this).addClass("selected");
    $(this).attr("contenteditable", "true"); // this ko contentEditable attribute diya
    $(this).focus();
  });
...
function updateCell(property, value, defaultPossible) {
  $(".input-cell.selected").each(function () {
    // it is for loop
    $(this).css(property, value); // this par update property
...
$(".icon-bold").click(function () {
  if ($(this).hasClass("selected")) {
    updateCell("font-weight", "", true); // property ko hatane ke liye blanck string paas karte hai
  } else {
      ...
      $(".sheet-rename").click(function () {
        $(".container").append(`<div class="sheet-rename-modal">
                                ...
                                <div class="action-buttons">
                                  ...
                                  <div class="cancel-button">Cancle</div>
                                </div>
                              </div>`);
